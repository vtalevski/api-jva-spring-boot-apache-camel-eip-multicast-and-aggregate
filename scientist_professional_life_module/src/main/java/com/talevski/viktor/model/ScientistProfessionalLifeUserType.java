...
public class ScientistProfessionalLifeUserType implements UserType {
    ...
    @Override
    public Class<ScientistProfessionalLifeResult> returnedClass() {
        return ScientistProfessionalLifeResult.class;
    }
