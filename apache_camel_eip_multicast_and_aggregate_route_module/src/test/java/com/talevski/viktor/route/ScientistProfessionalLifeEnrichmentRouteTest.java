...
public class ScientistProfessionalLifeEnrichmentRouteTest {
    private static final String ROUTE_SCIENTIST_PROFESSIONAL_LIFE_URI_MOCK = "{{route.scientist.professionalLife.uri}}";
    private static final String ROUTE_SCIENTIST_PROFESSIONAL_LIFE_ENDPOINT = "{{route.scientist.professionalLife.endpoint}}";
    ...
    @EndpointInject(value = ROUTE_SCIENTIST_PROFESSIONAL_LIFE_ENDPOINT)
    private ProducerTemplate producerTemplate;

    @Test
    public void shouldReturnScientistProfessionalLifeResponseWithScientistProfessionalLifeResult() throws Exception {
        ScientistProfessionalLifeResponse expectedScientistProfessionalLifeResponseObject = readJsonFileToObject(SCIENTIST_PROFESSIONAL_LIFE_RESPONSE_WITH_SCIENTIST_PROFESSIONAL_LIFE_RESULT, ScientistProfessionalLifeResponse.class);
        String expectedScientistProfessionalLifeResponseString = objectMapper.writeValueAsString(expectedScientistProfessionalLifeResponseObject);
        EnrichmentResult expectedEnrichmentResult = createExpectedEnrichmentResult(null, expectedScientistProfessionalLifeResponseObject, emptyList());

        ScientistRequest scientistRequest = readJsonFileToObject(SCIENTIST_REQUEST_VALID, ScientistRequest.class);
        scientistProfessionalLifeUriMockEndpoint.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(expectedScientistProfessionalLifeResponseString, String.class));
    ...
    public void shouldCatchHttpOperationFailedException() throws Exception {
        ...
        ScientistRequest scientistRequest = readJsonFileToObject(SCIENTIST_REQUEST_VALID, ScientistRequest.class);
        scientistProfessionalLifeUriMockEndpoint.whenAnyExchangeReceived(exchange -> {
    ...
    public void shouldCatchCommunicationWithExternalServiceException() throws Exception {
        ScientistProfessionalLifeResponse expectedScientistProfessionalLifeResponseObject = readJsonFileToObject(SCIENTIST_PROFESSIONAL_LIFE_RESPONSE_WITH_SCIENTIST_PROFESSIONAL_LIFE_ERROR, ScientistProfessionalLifeResponse.class);
        String expectedScientistProfessionalLifeResponseString = objectMapper.writeValueAsString(expectedScientistProfessionalLifeResponseObject);
        EnrichmentResult expectedEnrichmentResult = createExpectedEnrichmentResult(null, null, singletonList(createScientistError(EXTERNAL_API_NO_CONTENT, NO_VALUE_FROM_EXTERNAL_PROFESSIONAL_SCIENTIST_API)));


        ScientistRequest scientistRequest = readJsonFileToObject(SCIENTIST_REQUEST_NOT_EXIST, ScientistRequest.class);
        scientistProfessionalLifeUriMockEndpoint.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(expectedScientistProfessionalLifeResponseString, String.class));
        mockMapperProcessor(CommunicationWithExternalServiceException.class, NO_VALUE_FROM_EXTERNAL_PROFESSIONAL_SCIENTIST_API, expectedEnrichmentResult);
        EnrichmentResult actualEnrichmentResult = producerTemplate.send(producerTemplate.getDefaultEndpoint(), InOut, exchange -> exchange.getIn().setBody(scientistRequest, ScientistRequest.class)).getIn().getBody(EnrichmentResult.class);
